...
app.use('/gible', function (req, res) {
    res.send('<title>Gible</title><link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous"><link rel="stylesheet" href="styles.css"><div class="card" style="width: 30vw;"><div class="card-body"><div class="col-1-2"><div id="sprite" align="center"></div></div><div class="col-1-2" id="text"><h5 class="card-title" align="center"></h5><p class="card-text" align="center"></p></div><div class="col-1-1"><div align="center"><a href="localhost:3000/" class="btn btn-secondary">Back</a></div></div></div></div><script src="pokemon.js"></script>')
});
